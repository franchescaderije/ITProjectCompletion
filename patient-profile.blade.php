                    ...
                    <div class="box-body">
                      <table class='table table-bordered'>
                        <tr>
                          ...
                          <th>Birthday:</th>
                          <td><span class="text-muted"> {{date('M d, Y', strtotime($patient->patient_bday))}}</span> </td>
                        </tr>
                        <tr>
                          <th>Mother:</th>
                        ...
                        @else
                           <td><span class="text-muted">NA</span></td>
                        @endif  
                        </tr>
                      </table>
                    </div> 
                            ...
                            <div class="row">
                                  ...
                                  <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" name="date_administered" id="dateadministered">
                                    </div>
                                  </div>  
                            </div>
                          </div>
        ...
        <div class="tab-pane" id="med_record">
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              ...
              <li><a href="#immune" data-toggle="tab">Immunizations</a></li>
            ...
            <div class="tab-content no-padding">
              ...
              <div class="chart tab-pane" id="immune" style="position: relative height: 400px;">
                <div class="row">
                  <div class="col-md-12">
                    <div class="box box-info">
                      <div class="box-header">
                          <center><h3 class="box-title">Immunizations</h3></center>
                      </div>
                      <div class="box-body">
...
<script>
  ...
  $('#vactype').on('change', function(e){
    ...
    $('#lotnumber').on('change', function(e){
      console.log(e);
      var lotnum = e.target.value;

      $.get('{{ url('administervaccine') }}/create/ajax-state/lotnum?lotnum=' + lotnum, function(data) {
          console.log(data);
          var today = new Date();
          ...
          today = yyyy+'-'+mm+'-'+dd;
          $.each(data, function(index,value){
            document.getElementById('dateadministered').min=value.vaccine_receive_date;
            document.getElementById('dateadministered').max=today;
          });
        ...
        function loadmodal(id){
          ...
          success: function(data){
            ...
            $.each(data,function(index,val){
               ...
               document.getElementById('date_administered').max=today;

               document.getElementById('date_administered').min=weeksbefore;
